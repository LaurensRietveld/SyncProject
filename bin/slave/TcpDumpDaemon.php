...
<?php
	...
	$stopTcp = $config['experiments']['experimentCacheDir']."/s_stopTcpDump";
	$storeFile = $config['experiments']['experimentCacheDir']."/tcpDump/s_dump.txt";
	while (true) {
	...
	function stopDaemon() {
		shell_exec("/home/lrd900/gitCode/bin/slave/stopTcpDump.php");
	}
